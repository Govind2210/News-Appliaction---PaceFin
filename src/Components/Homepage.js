...
class News extends React.Component {
        ...
        return (
          ...
          <div className="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div className="px-6 pt-4 pb-2">
              ...
              <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Govind</span>
    ...
    render() {
      ...
      return (
        <>
          {/* <Navbar/> */}
          <div className=" p-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-1">{this.state.name1} </div>
        </>
      )
  }}
